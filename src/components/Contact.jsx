function Contact() {
  return (
    <section
      id="contact"
      className="relative py-20 px-6 bg-gradient-to-br from-[#050816] via-[#0b1021] to-[#050816] text-white text-center overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-md mx-auto bg-white/10 border border-white/10 backdrop-blur-lg p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.7)] transform hover:-translate-y-2 hover:rotate-1 transition-all duration-500">
